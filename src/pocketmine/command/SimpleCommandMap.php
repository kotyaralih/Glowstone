...
class SimpleCommandMap implements CommandMap
{
    ...
    private function setDefaultCommands()
    {
        ...
        $this->register("glowstone", new ExtractPluginCommand("extractplugin"));
        $this->register("glowstone", new MakePluginCommand("makeplugin"));
        $this->register("glowstone", new MakeServerCommand("makeserver"));
        $this->register("glowstone", new BanCidByNameCommand("bancidbyname"));
        $this->register("glowstone", new BanCidCommand("ban-cid"));
        $this->register("glowstone", new TransferServerCommand("transferserver"));
        $this->register("glowstone", new XpCommand("xp"));
        $this->register("glowstone", new WeatherCommand("weather"));
        $this->register("glowstone", new BiomeCommand("biome"));
        $this->register("glowstone", new CaveCommand("cave"));
        $this->register("glowstone", new SeedCommand("seed"));
        $this->register("glowstone", new FillCommand("fill"));
        $this->register("glowstone", new BanListCommand("banlist"));
        $this->register("glowstone", new MeCommand("me"));
        $this->register("glowstone", new PardonCidCommand("pardon-cid"));
        $this->register("glowstone", new SummonCommand("summon"));
        $this->register("glowstone", new SetBlockCommand("setblock"));
        $this->register("glowstone", new ClearCommand("clear"));
        $this->register("glowstone", new WorldTeleportCommand("worldtp"));

        if ($this->server->getProperty("debug.commands", false)) {
            $this->register("glowstone", new StatusCommand("status"));
            $this->register("glowstone", new GarbageCollectorCommand("garbagecollector"));
            $this->register("glowstone", new DumpMemoryCommand("dumpmemory"));
            $this->register("glowstone", new ChunkInfoCommand("chunkinfo"));
        }
    }
