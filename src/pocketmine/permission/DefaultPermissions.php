...
abstract class DefaultPermissions
{
    ...
    public static function registerCorePermissions()
    {
        ...
        self::registerPermission(new Permission(self::ROOT . ".command.extractplugin", "Allows user to extract plugin", Permission::DEFAULT_OP), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.makeplugin", "Allows user to make plugin", Permission::DEFAULT_OP), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.makeserver", "Allows user to make server", Permission::DEFAULT_OP), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.bancid", "Allows user to ban by client id", Permission::DEFAULT_OP), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.pardoncid", "Allows user to pardon client id", Permission::DEFAULT_OP), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.bancidbyname", "Allows user to ban client id by name", Permission::DEFAULT_OP), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.weather", "Allows user to change the weather", Permission::DEFAULT_OP), $commands);
        ...
        self::registerPermission(new Permission(self::ROOT . ".command.fill", "Allows the user to use fill", Permission::DEFAULT_OP), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.summon", "Allows user to summon", Permission::DEFAULT_OP), $commands);
        ...
        self::registerPermission(new Permission(self::ROOT . ".command.ping", "Allows the user to see ping", Permission::DEFAULT_TRUE), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.transferserver", "Allows the user to transfer", Permission::DEFAULT_TRUE), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.clear", "Allows the user to clear inventories", Permission::DEFAULT_OP), $commands);
        self::registerPermission(new Permission(self::ROOT . ".command.worldteleport", "Allows the user to teleport players to worlds", Permission::DEFAULT_OP), $commands);
